...
export class PackedBoxDto {
  @ApiProperty({ nullable: true }) @IsOptional() caixa_id: string | null;
  @ApiProperty({ type: [String] }) @IsArray() produtos: string[];
  @ApiProperty({ required: false }) @IsOptional() observacao?: string;
}
